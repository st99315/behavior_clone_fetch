...
# dataset directory
DIRECTORY_SET="train_data_diff_color_0615"
# log directory
...
do
    ...
    python ../fetch_remote/fetch_pick_object_data.py -si $s -ei $e -ext -r -s -dir ../$DIRECTORY_SET/train_data > $DIRECTORY/gen_$s_$e.log 2>&1 &
